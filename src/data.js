...
export const reviews = [
  ...
  },
  {
    ...
    reviews: [
      {
        review:
          'Great work Zia Arsalan, Maybe we can make an appointment together?',
        date: 'Jun, 2020',
      },
      {
        review:
          'I need your expertise to create an unique template with loyalty points.',
        date: 'Jun, 2020',
      },
    ],
  },
  ...
  },
  {
    ...
    reviews: [
      {
        review:
          'Congratulations, you have done it without Interogromat. You are a crack !!',
        date: 'Jul, 2020',
      },
    ],
  },
...
export const social = [
  ...
  {
    name: 'twitter',
    link: 'https://twitter.com/ZiaArsalan94',
    icon: 'ant-design:twitter-outlined',
  },
  {
    name: 'Fiverr',
    link: 'https://www.fiverr.com/ziaarsal',
