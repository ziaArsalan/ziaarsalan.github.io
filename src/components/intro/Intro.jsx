...
import ParticleAnimation from '../particle-animation/particle-animation'
import Title from '../../img/Title'
import TitleLight from '../../img/TitleLight'
  ...
  return (
    <div className='i'>
      <div className='i-left'>
        <div className='i-left-wrapper'>
          ...
          <div className='d-block d-md-none'>
            <ParticleAnimation
              Image={theme.state.darkMode ? TitleLight : Title}
            />
          </div>
      ...
      <div className='i-right'>
        ...
        <img src={Me} alt='zia arsalan' className='i-img' />
      </div>
    </div>
  )
}
